...
//
//   - two-sided round UP    Back Extensions 247.5: 70% = 86.625/side -> 90
//   - two-sided round DOWN  Back Extensions 90% = 111.375/side -> 110
//   - top set UNCHANGED     Back Ext top 123.75/side (45,25,5,2.5,1.25) exact
//
...
(async () => {
    ...
    try {
        ...
        contains(backExt, 'Per side: 123.75 lbs', 'two-sided top set per side exact 123.75');
        contains(backExt, 'Warmup Set #1 (180 lbs', 'two-sided W1 86.625/side rounds UP to 90 (total 180)');
        contains(backExt, 'Per side: 90 lbs', 'two-sided W1 per side = 90');
        contains(backExt, 'Warmup Set #2 (220 lbs', 'two-sided W2 111.375/side rounds DOWN to 110 (total 220)');
