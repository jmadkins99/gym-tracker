...
//
//   - two-sided round UP    Incline Chest Press 247.5: 70% = 86.625/side -> 90
//   - two-sided round DOWN  Incline 90% = 111.375/side -> 110
//   - top set UNCHANGED     Incline top 123.75/side (45,25,5,2.5,1.25) exact
...
(async () => {
    ...
    try {
        ...
        contains(incline, 'Top Set (247.5 lbs)', 'incline top set exact 247.5 (never rounded)');
        contains(incline, 'Per side: 123.75 lbs', 'incline top set per side exact 123.75');
        contains(incline, 'Warmup Set #1 (180 lbs', 'incline W1 86.625/side rounds UP to 90 (total 180)');
        contains(incline, 'Per side: 90 lbs', 'incline W1 per side = 90');
        contains(incline, 'Warmup Set #2 (220 lbs', 'incline W2 111.375/side rounds DOWN to 110 (total 220)');
